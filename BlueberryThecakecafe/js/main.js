document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCarousel() {
        ...
        const customThemeCakes = [
            { name: "Custom Theme Design", image: "Customized cake Previews/0001.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0002.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0003.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0004.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0005.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0006.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0007.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0008.png" },
            { name: "Custom Theme Design", image: "Customized cake Previews/0009.png" },
            { name: "Barbie Doll Shape Cake", image: "Customized cake Previews/Barbie Doll Shape cake.png" },
            { name: "Lion Theme", image: "Customized cake Previews/Lion Theme.png" },
            { name: "Princess Theme Crown Two Tier", image: "Customized cake Previews/Princess Theme with crown two tier.png" },
            { name: "Triple Color Icing Three Tier", image: "Customized cake Previews/tripple color icing with three tier.png" }
        ];
